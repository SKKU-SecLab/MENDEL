...
from explib.eval_methods import get_best_f1, get_adjusted_composite_metrics, get_accuracy_score
...
def main(exp: mltk.Experiment[PredictConfig], test_config: PredictConfig):
    ...
    print("transfer_type",train_config.transfer_type, "transfer_size", train_config.transfer_size)
    # prepare the data
    # simple data
    (x_train, _), (x_test, y_test) = \
        get_data(train_config.dataset, train_config.train.max_train_size, train_config.test.max_test_size,
                 ...
                 valid_portion=train_config.train.valid_portion, size=train_config.transfer_size, tr_type=train_config.transfer_type)
    ...
    if train_config.dataset == 'SWaT' or train_config.dataset == 'WADI' or train_config.dataset == 'HAI':
    ...
    restore_m_path = os.path.join(test_config.load_model_dir, 'result_params/restored_params.dat.meta')
    # transfer laerning
    ...
    with spt.utils.create_session().as_default() as session:
        ...
        saver = tf.train.import_meta_graph(restore_m_path)
        ...
        accuracy = get_accuracy_score(t[3],t[4],t[5],t[6])
